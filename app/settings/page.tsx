        ...
        <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-primary/5 border border-primary/20 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold text-primary">Connected Successfully</p>
            ...
            <div className="border-b border-gray-200 bg-gray-50 px-6 py-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-3 py-2 text-sm font-medium text-primary bg-primary/5 hover:bg-primary/10 border border-primary/20 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            ...
            <div className="p-6">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 text-primary rounded focus:ring-2 focus:ring-primary"
                />
                <div>
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              disabled={saving}
              className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors disabled:bg-primary/60 disabled:cursor-not-allowed"
            >
